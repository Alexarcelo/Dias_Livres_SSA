...
st.session_state.aba_sheet = 'Configurações Salvador'

st.session_state.titulo = 'Dias Livres por Voo - Salvador'

st.session_state.titulo_2 = 'Dias Livres por Hotel - Salvador'

st.session_state.titulo_3 = 'Dias Livres Acumulados por Hotel - Salvador'

st.session_state.titulo_4 = 'Aproveitamento Dias Livres - Salvador'
